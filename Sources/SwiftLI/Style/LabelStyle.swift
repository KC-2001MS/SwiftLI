...
///     func makeBody(configuration: Configuration) -> Group {
///         Group(contents: [
///             Text(verbatim: "["),
///             configuration.icon,
///             Text(verbatim: "] "),
...
public protocol LabelStyle {
    ...
    /// - Returns: A ``Group`` containing the laid-out icon and/or title.
    @ViewBuilder
    func makeBody(configuration: Self.Configuration) -> Group
}
...
public struct DefaultLabelStyle: LabelStyle {
    ...
    public func makeBody(configuration: Configuration) -> Group {
        Group(contents: [
            configuration.icon,
            Spacer(),
            configuration.title
...
public struct IconOnlyLabelStyle: LabelStyle {
    ...
    public func makeBody(configuration: Configuration) -> Group {
        Group(contents: [configuration.icon])
    }
}
...
public struct TitleOnlyLabelStyle: LabelStyle {
    ...
    public func makeBody(configuration: Configuration) -> Group {
        Group(contents: [configuration.title])
    }
}
