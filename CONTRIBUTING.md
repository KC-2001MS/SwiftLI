...
Thank you for your interest in contributing to SwiftLI. SwiftLI provides an easy way to persist data without using Key Value and is designed to integrate seamlessly with SwiftUI.

## How to Contribute

Contributions to SwiftLI are warmly welcomed and appreciated. Here are the areas where you can help:
...
1. Fork the [SwiftLI repository](https://github.com/KC-2001MS/SwiftLI) and clone it to your local machine.
...
SwiftLI adheres to the Contributor Covenant Code of Conduct (https://github.com/KC-2001MS/SwiftLI/blob/main/CODE_OF_CONDUCT.md) to create an inclusive and respectful environment for all users. Harassment of any kind is strictly prohibited. Kindly review the Code of Conduct for further details.
...
Your interest, assistance, and feedback are invaluable in enhancing the SwiftLI library. Thank you for your continued support.
